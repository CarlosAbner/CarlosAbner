...
I am a data professional focused on building scalable, automated solutions that bridge the gap between Business Intelligence and Data Engineering. Currently working in the Electricity Trading Sector, I develop complex data pipelines and serverless automations that drive strategic decision-making.



<!-- meus objetivos -->
## About Me:
**Current Role**: Analytics Engineer at Grupo Urca Energia, managing cloud infrastructure and critical data integrations.

**Expertise**: Designing ETL/ELT processes with Python, managing SQL Server databases, and orchestrating cloud workflows with Azure Functions and Docker.

**Education**: B.S. in Database Administration and currently pursuing a Postgraduate degree in Big Data & Data Science.

**Award**: Recognized as "Employee of the Year" in 2023 for technical excellence and impact.

<!-- tecnologias utilziadas -->
## Tech Stack & Tools
   - **Languages**: Python (Advanced), SQL, Java (Learning/Spring Boot);
   - **Data & Cloud**: Azure (Functions, Cloud, SQL), MySQL, SQL Server, Microsoft Fabric;
   - **Engineering**: Docker, CI/CD (GitHub Actions), Web Scraping, REST APIs;
   - **BI/Analytics**: Power BI (Strategic Dashboards), DAX, M-Language.

## Current Goals

Building even more resilient and reactive data systems using Java/Spring.

Automating cloud infrastructure to reach the highest level of Data Engineering.

Contributing to open-source projects and the global tech community.
